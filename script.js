...
const CONFIG = {
    ...
    GST_RATE: 0.0, // 18%
  REFERRAL_DISCOUNT_PERCENTAGE: 0.2, // 20%
  INTRODUCTORY_DISCOUNT_PERCENTAGE: 0.5, // 50%
  UPI_QR_CODE_URL:
  ...
  PAYMENT_OPTIONS: [
    ...
    PRODUCTS: [
        {
          id: 'cosmic_math_tool',
          name: 'Cosmic Math Tool',
          img: 'https://sjvggeiqczywnilrarml.supabase.co/storage/v1/object/public/cosmathic-files//NIFTY-Chart.png',
          description:
            'Real-time and predictive trends, A-I based entry/exit signals, Multiple time-frame analysis',
          user_guide_pdf: 'cosmic-math-tool_guide.pdf',
          min_price: 2500,
          subscription_plans: [
            { type: 'Monthly', duration_days: 30, usual_price: 2500 },
            { type: 'Half-Yearly', duration_days: 180, usual_price: 15000 },
            { type: 'Annual', duration_days: 365, usual_price: 30000 },
          ],
        },
        {
          id: 'cosmic_astro_tool',
          name: 'Cosmic Astro Tool',
          img: 'https://sjvggeiqczywnilrarml.supabase.co/storage/v1/object/public/cosmathic-files//Dow-Jones-Chart.png',
          description:
            'Real-time planetary position tracking, Definitive planetary support and resistance, Significant dynamic time-markers',
          user_guide_pdf: 'cosmic-astro-tool_guide.pdf',
          min_price: 2500,
          subscription_plans: [
            { type: 'Monthly', duration_days: 30, usual_price: 2500 },
            { type: 'Half-Yearly', duration_days: 180, usual_price: 15000 },
        ...
        {
          id: 'cosmic_vibration_addon',
          name: 'Cosmic Vibration [Add-on]',
          img: 'https://sjvggeiqczywnilrarml.supabase.co/storage/v1/object/public/cosmathic-files//BankNifty-Chart.png',
          description:
            'In-sync universal cosmic frequency, Trend-based actionable trading signals, Dynamic confirmation indicator',
          user_guide_pdf: 'cosmic-vibration-addon_guide.pdf',
          min_price: 0,
          subscription_plans: [],
        },
      ],
...
function showSubscriptionModal(productId) {
 ...
 // Defensive check for subscription_plans
  ...
  selectedProduct.subscription_plans.forEach((plan) => {
    ...
    const perDayPrice = finalPrice / plan.duration_days; // Calculate per-day price
